...
export default async function AdminLogin() {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/3 bg-gradient-to-br from-oxal-verdigris to-oxal-desert relative">
        <div 
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="text-center text-white">
            ...
            <p className="text-2xl text-oxal-sandstone">
      ...
      <div className="w-full lg:w-2/3 flex items-center justify-center bg-oxal-cream">
