      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="w-16 h-16 bg-oxal-sandstone rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-oxal-teak leading-relaxed">
        ...
        <div className="text-center mt-12 p-8 bg-gradient-to-r from-oxal-verdigris to-oxal-desert rounded-2xl">
          <h3 className="text-2xl font-bold text-white mb-4">
            {t('cta.title')}
          </h3>
          <p className="text-oxal-sandstone mb-6 max-w-md mx-auto">
            {t('cta.subtitle')}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="mailto:hola@oxal.shop"
              className="border-2 border-white text-white px-6 py-3 rounded-full font-semibold hover:bg-white hover:text-oxal-verdigris transition-colors"
            >
              {t('cta.email')}
            </a>
            <a
